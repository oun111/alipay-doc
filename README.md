...
目录
<!-- TOC -->autoauto- [惠通支付宝商户对接文档](#惠通支付宝商户对接文档)auto    - [文档修改记录](#文档修改记录)auto    - [文档简介](#文档简介)auto        - [特别声明](#特别声明)auto        - [阅读对象](#阅读对象)auto        - [技术支持服务](#技术支持服务)auto    - [签名加密](#签名加密)auto        - [签名算法介绍](#签名算法介绍)auto        - [名词解释](#名词解释)auto        - [商户端加解密步骤详解](#商户端加解密步骤详解)auto            - [请求参数处理过程](#请求参数处理过程)auto            - [同步/异步响应结果处理过程](#同步异步响应结果处理过程)auto    - [接口简介](#接口简介)auto        - [支付宝H5下单接口](#支付宝h5下单接口)auto            - [说明](#说明)auto            - [请求地址](#请求地址)auto            - [请求方式](#请求方式)auto            - [请求参数](#请求参数)auto            - [返回参数](#返回参数)auto            - [示例代码](#示例代码)auto        - [异步通知](#异步通知)auto            - [说明](#说明-1)auto            - [策略](#策略)auto            - [发送方式](#发送方式)auto            - [通知内容](#通知内容)auto        - [订单查询接口](#订单查询接口)auto            - [说明](#说明-2)auto            - [请求地址](#请求地址-1)auto            - [请求方式](#请求方式-1)auto            - [请求参数](#请求参数-1)auto            - [返回参数](#返回参数-1)auto        - [附录](#附录)auto            - [订单状态说明](#订单状态说明)auto            - [签名示例](#签名示例)autoauto<!-- /TOC -->
